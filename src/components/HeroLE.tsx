...
import { ArrowDown, Github, Linkedin, Mail, Sparkles, BarChart3, ClipboardCheck, Code2 } from "lucide-react";
import { experiencesLE, personalInfoLE, projectsLE } from "@/data/portfolio-le";
import Image from "next/image";

export function HeroLE() {
  const stats = [
    { value: projectsLE.length.toString(), label: "Shipped Projects" },
    { value: experiencesLE.length.toString(), label: "Roles" },
  ...
  const featureCards = [
    {
      icon: ClipboardCheck,
      title: "Grader / Program Support",
      description: "Learner-facing grading and academic support across live programs, including course QA, assessment workflows, and content preparation—building first-hand understanding of course delivery and learner needs.",
    ...
    },
    {
      icon: BarChart3,
      title: "Data Analyst",
      description: "Product, growth, and impact analysis across Learning Enterprise offerings, including longitudinal learner metrics, engagement analysis, and executive-ready reporting.",
    ...
    {
      icon: Code2,
      title: "Research Analyst (Software Engineering)",
      description: "Production engineering and applied AI work, including internal automation tools, AI system evaluation, and contributions to production platforms used across Learning Enterprise.",
  ...
  const nameText = personalInfoLE.name;
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden pt-24 pb-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
        ...
        >
          <div className="w-36 h-36 mx-auto rounded-full bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 p-1.5 shadow-2xl shadow-blue-500/20">
            <div className="w-full h-full rounded-full bg-gray-100 overflow-hidden">
              {personalInfoLE.profileImage ? (
                <Image
                  src={personalInfoLE.profileImage}
                  alt={personalInfoLE.name}
                  width={144}
                  height={144}
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50">
                  <span className="text-5xl font-bold text-blue-600">
                    {personalInfoLE.name.split(" ").map(n => n[0]).join("")}
                  </span>
                </div>
              )}
            </div>
        ...
        >
          Building production software at ASU Learning Enterprise over nearly 3 years—at the intersection of backend systems, applied AI, and workflow automation.
        </motion.p>
        ...
        >
          <p className="text-xs uppercase tracking-[0.2em] text-gray-400 mb-4">
            Role Progression at Learning Enterprise
          </p>
          <div className="relative">
            <div className="pointer-events-none absolute inset-0 z-0 hidden md:block">
              <svg className="w-full h-full" viewBox="0 0 100 20" preserveAspectRatio="none">
                <defs>
                  <linearGradient id="roleProgressionGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#06b6d4" />
                    <stop offset="50%" stopColor="#3b82f6" />
                    <stop offset="100%" stopColor="#8b5cf6" />
                  </linearGradient>
                </defs>
                <line x1="15" y1="10" x2="48" y2="10" stroke="url(#roleProgressionGradient)" strokeWidth="4" strokeLinecap="round" />
                <line x1="52" y1="10" x2="85" y2="10" stroke="url(#roleProgressionGradient)" strokeWidth="4" strokeLinecap="round" />
              </svg>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 relative z-10">
              {featureCards.map((card, index) => (
                <motion.div
                  ...
                  className="relative z-10 bg-white rounded-2xl p-5 border border-gray-100 shadow-lg shadow-gray-200/50 hover:shadow-xl hover:shadow-gray-200/60 transition-all duration-300 cursor-default"
                >
        ...
        >
          {[
            { href: personalInfoLE.github, icon: Github, label: "GitHub" },
            { href: personalInfoLE.linkedin, icon: Linkedin, label: "LinkedIn" },
            { href: `mailto:${personalInfoLE.email}`, icon: Mail, label: "Email" },
